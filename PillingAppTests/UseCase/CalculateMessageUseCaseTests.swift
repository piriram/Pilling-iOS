...
final class CalculateMessageUseCaseTests: XCTestCase {
    ...
    func test_사이클시작전_BeforeStart_메시지_반환() {
        ...
        if case .beforeStart(let days) = result.messageType {
            XCTAssertEqual(days, 5)
        } else {
            XCTFail("Expected beforeStart message type")
        }
    }
    ...
    func test_휴약일_Resting_메시지_반환() {
        ...
        // Then: resting 메시지
        XCTAssertEqual(result.messageType, .resting)
    }
    ...
    func test_정시복용_TodayAfter_메시지_반환() {
        ...
        // Then: todayAfter 메시지
        XCTAssertEqual(result.messageType, .todayAfter)
    }
    ...
    func test_너무일찍복용_TakenTooEarly_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .takenTooEarly)
    }
    ...
    func test_지연복용_TakenDelayedOk_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .takenDelayedOk)
    }
    ...
    func test_미복용_정시_PlantingSeed_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .plantingSeed)
    }
    ...
    func test_미복용_2시간초과_OverTwoHours_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .overTwoHours)
    }
    ...
    func test_미복용_4시간초과_OverFourHours_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .overFourHours)
    }
    ...
    func test_어제놓침_오늘미복용_PilledTwo_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .pilledTwo)
    }
    ...
    func test_어제놓침_오늘1알복용_Warning_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .warning)
    }
    ...
    func test_어제놓침_오늘2알복용_TakingBefore_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .takingBefore)
    }
    ...
    func test_연속2일미복용_Fire_메시지_반환() {
        ...
        // Then: fire 메시지 (긴급)
        XCTAssertEqual(result.messageType, .fire)
    }
    ...
    func test_연속3일이상미복용_Waiting_메시지_반환() {
        ...
        XCTAssertEqual(result.messageType, .waiting)
    }
